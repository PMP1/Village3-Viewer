...
These PNGs are active editable exterior wall geometry. They deliberately use simple
colours and obvious posts so module composition can be judged before final medieval
pixel art replaces them.
...
Internal walls now use separate placeholders under `../building-walls-internal/`,
