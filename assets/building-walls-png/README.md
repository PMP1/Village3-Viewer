...
the floor boundary. A dedicated 16×114 timber PNG marks solid-solid joins.
Separately loaded 24×114 stone PNGs cap only the two building ends, so adjacent
